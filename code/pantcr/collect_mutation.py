...
"""
Extract gene-assigned, coordinate-projected PanTCR observation records.

The script reads MiXCR rearranged TCR records, projects aligned V/J-region
sequence states onto gene-specific mature coding-region coordinates, and
computes diversity-based support fields used by graph construction and
...
class VariantAnalyzer:
    def __init__(self, input_file, gene_type, ref_file, minClns, minQual, min_count, filter_productive):
        ...
        if clone_count < minClns:
            ...
            print(f"Reliable allele-observation aggregation requires sufficient clone support.")
            print("="*60 + "\n")
    ...
    def run_analysis(self):
        ...
        for family, group in groups:
            ...
            ref_seq_full = self.ref_dict[family][ref_allele]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--filter_productive', type=str2bool, default=False, help='Filter non-productive sequences (Default: False)')
