...
K=5
MIN_NAIVE=1
METADATA="${SIM_REF_ROOT}/metadata.csv"
...
PY_SCRIPT="${PACKAGE_ROOT}/code/pantcr/build_pangenome_graph.py"

# ---------------- Arg Parsing ----------------
usage() {
  cat <<EOF
Usage:
  bash $0 --expr expr_ScenarioA --k 5 --min-naive 1 --metadata ref/metadata.csv
...
for gene in ${GENES//,/ }; do
  # Standardize gene labels to uppercase for directory names.
