...
#   3. Runs code/experiments/00_benchmark_utils/clones2alleles.py
...
REF_V="${SIM_REF_ROOT}/IMGT_TRB_default.csv"
REF_J="${SIM_REF_ROOT}/IMGT_TRB_default.csv"
...
usage() {
  cat <<EOF
Usage:
  bash $0 --expr expr_ScenarioA --pop "AFR EUR" --gene "V J"
